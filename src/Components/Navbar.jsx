    ...
    <>
        <div className='w-full flex justify-between items-center font-semibold'>
            ...
            <div className='flex items-center gap-4'>
                ...
                <p className='bg-green-500 text-white py-1 px-3 rounded-2xl text-[15px] cursor-pointer'>Install App</p>
                <p className='bg-black text-white py-1 px-3 rounded-2xl'>D/L</p>
